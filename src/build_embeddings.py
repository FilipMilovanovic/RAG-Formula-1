"""
Builds sentence embeddings for the processed Formula 1 dataset
...
# Loading the processed dataset created in preprocess_data.py
...
# Creating embeddings for every text document
...
# Building a simple FAISS index with Innner Product for cosine similarity
dim = embeddings.shape[1]
index = faiss.IndexFlatIP(dim)
index.add(embeddings)

# Saving the FAISS index to disk so we can reload it later for search
